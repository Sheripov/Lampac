...
# automatic updates
curl -k -s https://api.github.com/repos/Sheripov/Lampac/releases/latest | grep tag_name | sed s/[^0-9]//g > $DEST/vers.txt
curl -k -s https://raw.githubusercontent.com/Sheripov/lampac/main/update.sh > $DEST/update.sh
